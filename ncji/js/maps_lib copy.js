...
//  fusionTableId:      "1GjS_YSYL4puXPVcVDjFPJ8wl6Z3Ij693QJmiKms",
  fusionTableId:	  "1wI9KeXViGTcsgGxwP_Z5u_rs_mujZV7MKj0Jq6Bn",
  ...
  doSearch: function(location) {
    ...
    whereClause += " AND 'number' >= '" + $("#age-selected-start").html() + "'";
	whereClause += " AND 'number' <= '" + $("#age-selected-end").html() + "'";

    //-----custom filters-------
var type_column = "Last";
var tempWhereClause = [];
if ( $("#cbType1").is(':checked')) tempWhereClause.push("Smith");
if ( $("#cbType2").is(':checked')) tempWhereClause.push("McMahon");
if ( $("#cbType3").is(':checked')) tempWhereClause.push("Sneet");
